...
$result = mysql_query("SELECT InterviewDate FROM leads WHERE LeadsId=$lead_id");
while($row = mysql_fetch_array($result))
  {
	  $current_interview_date = date('d/m/Y g:i a',$row['InterviewDate']);
  }
...
$("#schedule_interview_button").click(function(){
	...
	$("#create_loader").show()
	$.post("ajax/schedule_interview_ajax.php?lead_id=<? echo $lead_id; ?>&reschedule=yes",
			{
...
Reschedule Interview<br><br>

Enter Date and Time

<input type='text' name='date_time_picker' id='date_time_picker' value='<? echo $current_interview_date; ?>' /> <br><br>
